<div class="container-fluid">
    <div class="row">
        ...
        $id = $_GET['id'];
        $query = "SELECT * FROM anggota a, jabatan j, user u WHERE a.id_jabatan = j.id AND a.id_user
= u.id AND a.id_user = '$id'";
                                    ...
                                    <select class="form-select" name="jabatan" name aria-label="Default select example">
                                        ...
                                        ?>
                                            <option value="<?= $row2['id']; ?>" <?=
                                                                                ($row['id_jabatan'] == $row2['id']) ? 'selected' : '' ?>><?= $row2['jabatan']; ?></option>
