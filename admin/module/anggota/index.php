            ...
            <div class="table-responsive small">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $query = "SELECT * FROM anggota a, jabatan j, user u WHERE a.id_jabatan =

j.id AND a.id_user = u.id order by a.id desc";
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?page=anggota/edit&id=<?php echo
                                                                            $row['id_user']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>

                                    <a href="fungsi/hapus.php?anggota=hapus&id=<?php echo
                                                                                $row['id_user']; ?>" onclick="javascript:return confirm('Hapus Data Anggota ?');" class="btn
